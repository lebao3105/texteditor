...
def make_trans():
    ...
    print(
        "* pywxrc {} (that"
        "s why you can"
        "t make app translate without wxPython installed)".format(pywxrc)
    )
    print("#####################################")
    ...
    os.system(
        pywxrc
        + " --gettext"
        + " textworker/ui/preferences.xrc"
        + " -o po/preferences.pot"
    )
    os.system(
        pywxrc + " --gettext" + " textworker/ui/autosave.xrc" + " -o po/autosave.pot"
    )
    os.system(
        gettext
    ...
    for line in open("po/LINGUAS", "r").read().split():
        ...
        os.system(
            msgmerge + " {} po/textworker.pot".format(target) + " -o {}".format(target)
        )
