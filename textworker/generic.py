...
class SettingsWindow:
    ...
    def __init__(self, parent):
        ...
        self.ColorPicker.Bind(
            ...
            lambda evt: (
                global_settings.set_setting("interface", "textcolor", evt.GetColour().GetAsString(wx.C2S_HTML_SYNTAX))
            )
        )
    ...
    def SelectFont(self, evt):
        ...
        global_settings.set_setting("interface", "textcolor", selected_color.GetAsString(wx.C2S_HTML_SYNTAX))
        ...
        wx.xrc.XRCCTRL(self.Frame, "m_staticText6").SetFont(selected_font)
    ...
    def SetFontColor(self, evt):
        ...
        if selected_item == _("Default"):
            return global_settings.set_setting(
                "interface", "textcolor", "default"
            )
        elif selected_item == _("Red"):
            return global_settings.set_setting(
                "interface", "textcolor", "red"
            )
        elif selected_item == _("Green"):
            return global_settings.set_setting(
                "interface", "textcolor", "green"
            )
    ...
    def SetTheme(self, evt):
        ...
        if selected_item == _("Dark"):
            return global_settings.set_setting(
                "interface", "color", "dark"
            )
        elif selected_item == _("Light"):
            return global_settings.set_setting(
                "interface", "color", "light"
            )
        elif selected_item == _("Automatic"):
            return global_settings.set_setting(
                "interface", "autocolor", "yes"
            )

    
    def Run(self, destroy:bool=False):
